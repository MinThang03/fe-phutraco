      ...
      <main className="pt-20">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-6">
                  Đô thị sinh thái hiện đại
                </h2>
                <p className="text-muted-foreground text-lg mb-6">
                  Khu đô thị Lương Sơn là dự án đô thị sinh thái quy mô lớn với đầy đủ tiện ích hiện đại, 
                  không gian xanh mát và cơ sở hạ tầng đồng bộ.
                </p>
              ...
              <div className="aspect-[4/3] rounded-2xl overflow-hidden">
                <img src="https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&h=600&q=80" alt="Khu đô thị" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-primary">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">Tư vấn phát triển đô thị</h2>
            <Link href="/lien-he" className="inline-flex items-center gap-2 bg-accent hover:bg-accent/90 text-primary px-8 py-4 rounded-xl font-medium transition-colors">
