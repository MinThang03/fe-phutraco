      ...
      <main className="pt-20">
          ...
          <div className="relative h-full flex items-center">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full">
              <div className="max-w-3xl">
                ...
                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6">Đại lý mua bán ký gửi</h1>
                <p className="text-xl text-white/90 mb-8">
                  Dịch vụ đại lý mua bán và ký gửi các loại hàng hóa, vật tư phục vụ nhu cầu đa dạng
                </p>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
              <div>
                ...
                <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-6">Đối tác thương mại tin cậy</h2>
                <p className="text-muted-foreground text-lg mb-6">
                  Với mạng lưới kho bãi và đối tác rộng khắp, Phutraco Holding cung cấp dịch vụ đại lý mua bán, 
                  ký gửi hàng hóa chuyên nghiệp, giúp doanh nghiệp tối ưu hóa chi phí và thời gian.
                </p>
                <div className="grid grid-cols-3 gap-6">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm text-muted-foreground">Giao dịch/năm</div>
                  </div>
                  <div className="text-center">
            ...
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-foreground mb-4">Các dịch vụ chúng tôi cung cấp</h2>
            </div>

            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                { title: "Mua bán ký gửi", desc: "Nhận ký gửi, mua bán hàng hóa, vật tư với hoa hồng hợp lý", icon: "📦" },
                { title: "Đại lý phân phối", desc: "Đại lý phân phối sản phẩm cho nhà sản xuất, mở rộng thị trường", icon: "🏪" },
                { title: "Môi giới thương mại", desc: "Kết nối người mua và người bán, tư vấn giao dịch an toàn", icon: "🤝" },
                { title: "Dịch vụ kho bãi", desc: "Cho thuê kho bãi, quản lý hàng hóa chuyên nghiệp", icon: "🏗️" },
              ].map((s) => (
        ...
        <section className="py-20 bg-primary">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">Cần dịch vụ đại lý?</h2>
